                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="stack admin logo"
                             src="/backend/app-assets/images/logo/stack-logo-light.png">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list">
                                <a href="javascript:void(0)">
                                    {{--                                    @if(count($historyNotifications))--}}
                                    {{--                                        @foreach($historyNotifications as $key => $item)--}}
                                    {{--                                            <div class="media">--}}
                                    ...
                                    {{--                                                        <p class="notification-text font-small-3 text-muted">{{$item->content}}</p>--}}
                                    {{--                                                        <small>--}}
                                    {{--                                                            <time class="media-meta text-muted"--}}
                                    {{--                                                                  datetime="2015-06-11T18:29:20+08:00">{{$item->created_at?$item->created_at->format('H:i d/m/Y'):null}}--}}
                                    {{--                                                            </time>--}}
                                    {{--                                                        </small>--}}
                                    {{--                                                    </a>--}}
                                    {{--                                                </div>--}}
...
{{--                  <img src="{{auth()->user()->avatar?url(auth()->user()->avatar):url('/backend/images/user.png')}}"--}}
{{--                       alt="avatar"><i></i></span>--}}
...
{{--                            <button type="submit" class="logout"><a class="dropdown-item"--}}
{{--                                                                    href="{{ route('admin.logout') }}"><i--}}
{{--                                        class="ft-power"></i> Logout</a></button>--}}
{{--                        </div>--}}
{{--                    </li>--}}
                </ul>
            </div>
